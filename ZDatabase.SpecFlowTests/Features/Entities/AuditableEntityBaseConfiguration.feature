Feature: Auditable Entity Base Configuration
  ...
  Scenario: CreatedOn property has after save behavior Ignore and value generator
    ...
    And the property 'CreatedOn' should have value generated OnAdd
    And the property 'CreatedOn' should use the generator 'DateTimeUtcGenerator'
  ...
  Scenario: LastChangedOn property has before and after save behavior Save and value generator
    ...
    And the property 'LastChangedOn' should have value generated OnAddOrUpdate
    And the property 'LastChangedOn' should use the generator 'DateTimeUtcGenerator'