Feature: Auditable Entity Configuration
  ...
  Scenario: CreatedByID property has after save behavior Ignore, foreign key, and value generator
    ...
    And the property 'CreatedByID' should have value generated on add
    And the property 'CreatedByID' should use the CurrentUserGenerator
  ...
  Scenario: LastChangedByID property has before and after save behavior Save, foreign key, and value generator
    ...
    And the property 'LastChangedByID' should have value generated on add or update
    And the property 'LastChangedByID' should use the CurrentUserGenerator
