...
namespace ZDatabase.EntityFrameworkCore.Audit.BusinessEntities.Audit
{
    ...
    /// <seealso cref="ZDatabase.EntityFrameworkCore.Audit.BusinessEntities.Audit.ServicesHistoryBase" />
    ...
    /// <summary>
    /// Entity configuration for <see cref="ZDatabase.EntityFrameworkCore.Audit.BusinessEntities.Audit.ServicesHistory{TUsers, TUsersKey}" />.
    /// </summary>
    /// <typeparam name="TServiceHistoryEntity">The type of the service history entity.</typeparam>
    /// <typeparam name="TUsers">The type of the users.</typeparam>
    /// <typeparam name="TUsersKey">The type of the users key.</typeparam>
    /// <seealso cref="ZDatabase.EntityFrameworkCore.Audit.BusinessEntities.Audit.ServicesHistoryBaseConfiguration{TServiceHistoryEntity}" />
