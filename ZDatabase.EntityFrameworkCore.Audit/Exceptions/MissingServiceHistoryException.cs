...
{
    /// <summary>
    /// Represents errors that occurs when the database context can not find any <see cref="ZDatabase.EntityFrameworkCore.Audit.BusinessEntities.Audit.ServicesHistory{TUsers, TUsersKey}"/>.
    /// </summary>
