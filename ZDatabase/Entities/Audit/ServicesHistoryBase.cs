...
namespace ZDatabase.Entities.Audit
{
    ...
    /// <summary>
    /// Entity configuration for <see cref="ZDatabase.Entities.Audit.ServicesHistoryBase" />.
    /// </summary>
    /// <typeparam name="TServiceHistoryEntity">The type of the service history entity.</typeparam>
    /// <seealso cref="ZDatabase.Entities.BaseEntityConfiguration{TServiceHistoryEntity}" />
