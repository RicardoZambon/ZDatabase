...
namespace ZDatabase.Entities.Audit
{
    ...
    /// <summary>
    /// Entity configuration for <see cref="ZDatabase.Entities.Audit.OperationsHistoryBase" />.
    /// </summary>
    /// <typeparam name="TOperationsHistoryEntity">The type of the operations history entity.</typeparam>
    /// <seealso cref="ZDatabase.Entities.BaseEntityConfiguration&lt;TOperationsHistoryEntity&gt;" />
