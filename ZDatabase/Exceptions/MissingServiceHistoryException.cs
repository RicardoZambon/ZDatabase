...
{
    /// <summary>
    /// Represents errors that occurs when the database context can not find any <see cref="ZDatabase.Entities.Audit.ServicesHistory{TServicesHistory, TOperationsHistory, TUsers, TUsersKey}"/>.
    /// </summary>
